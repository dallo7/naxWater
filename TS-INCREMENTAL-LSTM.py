...
#     """
#     Build Stateful (Incremental) LSTM model architecture
#
#     Stateful LSTM maintains hidden state across batches, enabling:
#     - Incremental learning from streaming data
#     - Continuous adaptation to new patterns
#     - Memory preservation across training epochs
#     """
#     model = Sequential()
#
#     # First Stateful LSTM layer
#     # Use Input layer to specify batch shape
#     from tensorflow.keras.layers import Input
#     model.add(Input(batch_shape=(batch_size, lookback, 1)))
#
#     model.add(LSTM(
#         units=units,
#         return_sequences=(layers > 1),
#         stateful=True,  # KEY: Maintains state across batches
...
#         history_val_maes = []
#
#         epochs = 50  # Reduced for incremental learning
#
